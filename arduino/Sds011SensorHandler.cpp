...
Sds011SensorHandler::Sds011SensorHandler()
  ...
  void Sds011SensorHandler::setSensorSerial(SoftwareSerial * serial) {
    if(serial == nullptr) {
      return;
    }
    sensorSerial = serial;
...
void Sds011SensorHandler::waitUntilReady() {
  while (sensorSerial == nullptr) {
    delay(100);
  }
}
